...
myString(res,limit_pos,knee_pos,limit_neg,knee_neg,attack,decay,noise) = excitation : nl_lagrangecombfilter(maxDel,N,aN,nl_element)
with{
...
inargs = vgroup("params",res,limit_pos,knee_pos,limit_neg,knee_neg,attack,decay,noise) with {
