...
CXXFLAGS='-O3 -std=c++11' CXX=/home/rick/git_checkouts/rpi-tools/arm-bcm2708/gcc-linaro-arm-linux-gnueabihf-raspbian-x64/bin/arm-linux-gnueabihf-g++ faust2supercollider -synthdef ./faust_src/*.dsp
rm -r norns_ugens
mkdir norns_ugens
