...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fVslider23 = (FAUSTFLOAT)3000.0f;
	dsp->fButton0 = (FAUSTFLOAT)0.0f;
	dsp->fVslider24 = (FAUSTFLOAT)90.0f;
	dsp->fVslider25 = (FAUSTFLOAT)0.20000000000000001f;
	dsp->fVslider26 = (FAUSTFLOAT)0.5f;
	dsp->fVslider27 = (FAUSTFLOAT)100.0f;
	dsp->fVslider28 = (FAUSTFLOAT)0.80000000000000004f;
	dsp->fVslider29 = (FAUSTFLOAT)8.0f;
	dsp->fVslider30 = (FAUSTFLOAT)0.0f;
	dsp->fVslider31 = (FAUSTFLOAT)50.0f;
	dsp->fVslider32 = (FAUSTFLOAT)50.0f;
	dsp->fVslider33 = (FAUSTFLOAT)90.0f;
	dsp->fVslider34 = (FAUSTFLOAT)0.80000000000000004f;
	dsp->fVslider35 = (FAUSTFLOAT)1.0f;
	dsp->fVslider36 = (FAUSTFLOAT)1.2f;
	...
	dsp->fVslider40 = (FAUSTFLOAT)0.20000000000000001f;
	dsp->fVslider41 = (FAUSTFLOAT)440.0f;
	...
	dsp->fVslider45 = (FAUSTFLOAT)1401.9000000000001f;
	dsp->fVslider46 = (FAUSTFLOAT)6150.3999999999996f;
	dsp->fVslider47 = (FAUSTFLOAT)0.20000000000000001f;
	dsp->fVslider48 = (FAUSTFLOAT)1.0f;
	dsp->fVslider49 = (FAUSTFLOAT)60.0f;
	dsp->fVslider50 = (FAUSTFLOAT)4.7300000000000004f;
	dsp->fButton8 = (FAUSTFLOAT)0.0f;
	dsp->fButton9 = (FAUSTFLOAT)0.0f;
	dsp->fVslider51 = (FAUSTFLOAT)12.0f;
	dsp->fVslider52 = (FAUSTFLOAT)0.98899999999999999f;
	dsp->fVslider53 = (FAUSTFLOAT)6000.0f;
	dsp->fVslider54 = (FAUSTFLOAT)1.0f;
	dsp->fVslider55 = (FAUSTFLOAT)1.0f;
	dsp->fVslider56 = (FAUSTFLOAT)200.0f;
	dsp->fVslider57 = (FAUSTFLOAT)1.5f;
	dsp->fVslider58 = (FAUSTFLOAT)20.0f;
	dsp->fVslider59 = (FAUSTFLOAT)10.0f;
	dsp->fVslider60 = (FAUSTFLOAT)3.0f;
	dsp->fVslider61 = (FAUSTFLOAT)50.0f;
	dsp->fVslider62 = (FAUSTFLOAT)-9.0f;
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "gulp", &dsp->fVslider50, 4.73000002f, 0.0f, 10.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "gulpdecay", &dsp->fVslider51, 12.0f, 0.0f, 100.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "freq", &dsp->fVslider49, 60.0f, 10.0f, 500.0f, 10.0f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "q_bl", &dsp->fVslider52, 0.989000022f, 0.800000012f, 0.990999997f, 0.00100000005f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "vol", &dsp->fVslider48, 1.0f, 0.0f, 10.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->openHorizontalBox(ui_interface->uiInterface, "compressor");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "attack", &dsp->fVslider59, 10.0f, 0.0f, 50.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "ratio", &dsp->fVslider60, 3.0f, 1.0f, 10.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "release", &dsp->fVslider61, 50.0f, 0.0f, 500.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "threshold", &dsp->fVslider62, -9.0f, -40.0f, 0.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->openHorizontalBox(ui_interface->uiInterface, "cp");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "clapfreq", &dsp->fVslider23, 3000.0f, 1000.0f, 3000.0f, 10.0f);
	ui_interface->addButton(ui_interface->uiInterface, "cp", &dsp->fButton0);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "decay", &dsp->fVslider24, 90.0f, 2.0f, 1500.0f, 0.100000001f);
	...
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "decay_oh", &dsp->fVslider45, 1401.90002f, 2.0f, 2000.0f, 0.100000001f);
	ui_interface->openHorizontalBox(ui_interface->uiInterface, "filt");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "tone", &dsp->fVslider46, 6150.3999f, 300.0f, 8000.0f, 0.200000003f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "vol", &dsp->fVslider47, 0.200000003f, 0.0f, 2.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "vol", &dsp->fVslider1, 0.100000001f, 0.0f, 2.0f, 0.00999999978f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider58, "1", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider58, "tooltip", "reverb pre-delay");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider58, "unit", "ms");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "pre_del", &dsp->fVslider58, 20.0f, 0.0f, 200.0f, 1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider56, "2", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider56, "scale", "log");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider56, "tooltip", "low band cutoff frequency");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider56, "unit", "Hz");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "lf_fc", &dsp->fVslider56, 200.0f, 30.0f, 1200.0f, 1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider55, "3", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider55, "tooltip", "-60db decay time for low band");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider55, "unit", "s");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "low_rt60", &dsp->fVslider55, 1.0f, 0.100000001f, 3.0f, 0.100000001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider54, "4", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider54, "tooltip", "-60db decay time for middle band");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider54, "unit", "s");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "mid_rt60", &dsp->fVslider54, 1.0f, 0.100000001f, 3.0f, 0.100000001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider53, "5", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider53, "scale", "log");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider53, "tooltip", "damping frequency (decay time is 1/2 mid)");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider53, "unit", "Hz");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "hf_damp", &dsp->fVslider53, 6000.0f, 1200.0f, 9800.0f, 1.0f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "level", &dsp->fVslider57, 1.5f, 0.0f, 2.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "freq", &dsp->fVslider41, 440.0f, 50.0f, 1000.0f, 0.00999999978f);
	...
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "vol", &dsp->fVslider40, 0.200000003f, 0.0f, 10.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "fattack", &dsp->fVslider32, 50.0f, 0.100000001f, 1000.0f, 0.100000001f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "fdecay", &dsp->fVslider33, 90.0f, 0.100000001f, 1000.0f, 0.100000001f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "filter_basis", &dsp->fVslider28, 0.800000012f, 0.0f, 10.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "filter_env", &dsp->fVslider29, 8.0f, 0.0f, 10.0f, 0.00999999978f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "filter_q", &dsp->fVslider36, 1.20000005f, 0.800000012f, 1.10000002f, 0.00100000005f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "frelease", &dsp->fVslider31, 50.0f, 0.100000001f, 1000.0f, 0.100000001f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "fsustain", &dsp->fVslider34, 0.800000012f, 0.0f, 1.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "release", &dsp->fVslider35, 1.0f, 0.100000001f, 1000.0f, 0.100000001f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "vol", &dsp->fVslider25, 0.200000003f, 0.0f, 5.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "freq", &dsp->fVslider27, 100.0f, 10.0f, 2000.0f, 0.100000001f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "gate", &dsp->fVslider30, 0.0f, 0.0f, 1.0f, 1.0f);
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "portamento", &dsp->fVslider26, 0.5f, 0.00999999978f, 1.0f, 0.00999999978f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow37 = min(0.26296702f, min(2.0f, ((1.0f / fSlow35) - fSlow35)));
	float fSlow38 = (float)dsp->fButton0;
	float fSlow39 = (0.00100000005f * (float)dsp->fVslider24);
	float fSlow40 = (float)dsp->fVslider25;
	float fSlow41 = (float)dsp->fVslider26;
	float fSlow42 = (0.00100000005f * (fSlow41 * (float)dsp->fVslider27));
	float fSlow43 = (1.0f - (0.00100000005f * fSlow41));
	float fSlow44 = (float)dsp->fVslider28;
	float fSlow45 = (float)dsp->fVslider29;
	float fSlow46 = (float)dsp->fVslider30;
	int iSlow47 = (fSlow46 > 0.0f);
	float fSlow48 = (0.00100000005f * (float)dsp->fVslider31);
	float fSlow49 = (float)dsp->fVslider32;
	int iSlow50 = (int)(dsp->fConst13 * fSlow49);
	float fSlow51 = (0.00100000005f * (float)dsp->fVslider33);
	float fSlow52 = (0.00100000005f * fSlow49);
	float fSlow53 = ((float)iSlow47 * (float)dsp->fVslider34);
	float fSlow54 = expf((0.0f - (dsp->fConst6 / (iSlow47?9.99999975e-05f:(0.00100000005f * (float)dsp->fVslider35)))));
	float fSlow55 = ((1.0f - fSlow54) * (iSlow47?fSlow46:0.0f));
	float fSlow56 = (2.0f * (1.0f - powf((float)dsp->fVslider36, 0.25f)));
	float fSlow57 = (8.0f * (float)dsp->fVslider37);
	float fSlow58 = (float)dsp->fVslider38;
	float fSlow59 = sinf((3.14159274f * min(0.25f, (dsp->fConst25 * fSlow58))));
	float fSlow60 = (2.0f * fSlow59);
	float fSlow61 = (float)dsp->fButton1;
	float fSlow62 = (float)dsp->fVslider39;
	...
	float fSlow70 = (float)dsp->fVslider40;
	float fSlow71 = (float)dsp->fVslider41;
	...
	float fSlow110 = (float)dsp->fVslider42;
	...
	float fSlow129 = (float)dsp->fVslider43;
	...
	float fSlow148 = (float)dsp->fVslider44;
	...
	float fSlow169 = (0.00100000005f * (float)dsp->fVslider45);
	float fSlow170 = sinf((3.14159274f * min(0.25f, (dsp->fConst12 * (float)dsp->fVslider46))));
	float fSlow171 = (2.0f * fSlow170);
	float fSlow172 = min(0.519834399f, min(2.0f, ((1.0f / fSlow170) - fSlow170)));
	float fSlow173 = (float)dsp->fVslider47;
	float fSlow174 = ((fSlow173 > 1.0f)?1.0f:((fSlow173 < -1.0f)?-1.0f:fSlow173));
	float fSlow175 = (float)dsp->fVslider48;
	float fSlow176 = (dsp->fConst12 * (float)dsp->fVslider49);
	float fSlow177 = (float)dsp->fVslider50;
	float fSlow178 = (float)dsp->fButton8;
	float fSlow179 = (float)dsp->fButton9;
	float fSlow180 = ((0.00100000005f * (float)dsp->fVslider51) + 0.00600000005f);
	float fSlow181 = (dsp->fConst0 * fSlow180);
	float fSlow182 = (dsp->fConst12 / (fSlow180 + -0.00600000005f));
	float fSlow183 = (float)dsp->fVslider52;
	float fSlow184 = cosf((dsp->fConst92 * (float)dsp->fVslider53));
	float fSlow185 = (float)dsp->fVslider54;
	...
	float fSlow194 = (float)dsp->fVslider55;
	float fSlow195 = ((expf((dsp->fConst94 / fSlow194)) / fSlow186) + -1.0f);
	float fSlow196 = (1.0f / tanf((dsp->fConst95 * (float)dsp->fVslider56)));
	float fSlow197 = (fSlow196 + 1.0f);
	float fSlow198 = (0.0f - ((1.0f - fSlow196) / fSlow197));
	float fSlow199 = (1.0f / fSlow197);
	float fSlow200 = (float)dsp->fVslider57;
	int iSlow201 = (int)min(8192.0f, max(0.0f, (dsp->fConst13 * (float)dsp->fVslider58)));
	...
	float fSlow265 = (float)dsp->fVslider59;
	float fSlow266 = expf((0.0f - (dsp->fConst134 / fSlow265)));
	float fSlow267 = (((1.0f / (float)dsp->fVslider60) + -1.0f) * (1.0f - fSlow266));
	float fSlow268 = expf((0.0f - (dsp->fConst34 / fSlow265)));
	float fSlow269 = expf((0.0f - (dsp->fConst34 / (float)dsp->fVslider61)));
	float fSlow270 = (float)dsp->fVslider62;
	/* C99 loop */
	{
		int i;
		for (i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp49 = (dsp->fRec58[1] + (fSlow36 * dsp->fRec59[1]));
			float fTemp50 = ((fTemp49 > 1.0f)?1.0f:((fTemp49 < -1.0f)?-1.0f:fTemp49));
			dsp->fRec58[0] = fTemp50;
			dsp->iRec60[0] = ((1103515245 * dsp->iRec60[1]) + 12345);
			float fTemp51 = (4.65661287e-10f * (float)dsp->iRec60[0]);
			float fTemp52 = (fTemp51 - (fTemp50 + (fSlow37 * dsp->fRec59[1])));
			float fTemp53 = ((fTemp52 > 1.0f)?1.0f:((fTemp52 < -1.0f)?-1.0f:fTemp52));
			float fTemp54 = (dsp->fRec59[1] + (fSlow36 * fTemp53));
			dsp->fRec59[0] = ((fTemp54 > 1.0f)?1.0f:((fTemp54 < -1.0f)?-1.0f:fTemp54));
			dsp->fVec6[0] = fSlow38;
			dsp->fRec62[0] = ((((fSlow38 - dsp->fVec6[1]) > 0.0f) > 0)?dsp->fConst13:max(0.0f, (dsp->fRec62[1] + -1.0f)));
			int iTemp55 = (dsp->fRec62[0] > 0.0f);
			dsp->iVec7[(dsp->IOTA & 8191)] = iTemp55;
			int iTemp56 = ((((iTemp55 + dsp->iVec7[((dsp->IOTA - dsp->iConst14) & 8191)]) + dsp->iVec7[((dsp->IOTA - dsp->iConst15) & 8191)]) + dsp->iVec7[((dsp->IOTA - dsp->iConst16) & 8191)]) + dsp->iVec7[((dsp->IOTA - dsp->iConst17) & 8191)]);
			int iTemp57 = (iTemp56 > 0);
			float fTemp58 = expf((0.0f - (dsp->fConst6 / (iTemp57?9.99999975e-05f:fSlow39))));
			dsp->fRec61[0] = ((dsp->fRec61[1] * fTemp58) + ((iTemp57?(float)iTemp56:0.0f) * (1.0f - fTemp58)));
			float fTemp59 = (float)tanhf((float)(fSlow34 * (dsp->fRec59[0] * dsp->fRec61[0])));
			float fTemp60 = (fTemp48 + fTemp59);
			dsp->fRec66[0] = (fSlow42 + (fSlow43 * dsp->fRec66[1]));
			dsp->iRec68[0] = (iSlow47 * (dsp->iRec68[1] + 1));
			int iTemp61 = (dsp->iRec68[0] < iSlow50);
			float fTemp62 = expf((0.0f - (dsp->fConst6 / (iSlow47?(iTemp61?fSlow52:fSlow51):fSlow48))));
			dsp->fRec67[0] = ((dsp->fRec67[1] * fTemp62) + ((iSlow47?(iTemp61?(float)iSlow47:fSlow53):0.0f) * (1.0f - fTemp62)));
			float fTemp63 = sinf((3.14159274f * min(0.25f, (dsp->fConst12 * (dsp->fRec66[0] * (fSlow44 + (fSlow45 * dsp->fRec67[0])))))));
			float fTemp64 = (dsp->fRec64[1] + (2.0f * (fTemp63 * dsp->fRec65[1])));
			float fTemp65 = (fTemp64 + 0.119999997f);
			float fTemp66 = (0.666666687f * fTemp65);
			float fTemp67 = ((fTemp66 > 1.0f)?1.0f:((fTemp66 < -1.0f)?-1.0f:(fTemp64 + (0.119999997f - (0.148148149f * mydsp_faustpower3_f(fTemp65))))));
			dsp->fRec64[0] = (fTemp67 + -0.119999997f);
			dsp->fRec70[0] = ((dsp->fRec70[1] * fSlow54) + fSlow55);
			float fTemp68 = max(1.00000001e-07f, fabsf(dsp->fRec66[0]));
			float fTemp69 = (dsp->fRec71[1] + (dsp->fConst7 * fTemp68));
			float fTemp70 = (fTemp69 + -1.0f);
			int iTemp71 = (fTemp70 < 0.0f);
			dsp->fRec71[0] = (iTemp71?fTemp69:fTemp70);
			float fRec72 = (iTemp71?fTemp69:(fTemp69 + ((1.0f - (dsp->fConst0 / fTemp68)) * fTemp70)));
			dsp->fRec69[0] = ((dsp->fRec70[0] * ((2.0f * fRec72) + -1.0f)) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec69[2]) + (dsp->fConst24 * dsp->fRec69[1]))));
			float fTemp72 = (dsp->fConst22 * (dsp->fRec69[2] + (dsp->fRec69[0] + (2.0f * dsp->fRec69[1]))));
			float fTemp73 = (fTemp67 + (dsp->fRec65[1] * min(fSlow56, min(2.0f, ((1.0f / fTemp63) - fTemp63)))));
			float fTemp74 = (fTemp72 + (0.239999995f - fTemp73));
			float fTemp75 = (0.666666687f * fTemp74);
			float fTemp76 = (((fTemp75 > 1.0f)?1.0f:((fTemp75 < -1.0f)?-1.0f:(fTemp72 + (0.239999995f - (fTemp73 + (0.148148149f * mydsp_faustpower3_f(fTemp74))))))) + -0.119999997f);
			float fTemp77 = (dsp->fRec65[1] + (2.0f * (fTemp63 * fTemp76)));
			float fTemp78 = (fTemp77 + 0.119999997f);
			float fTemp79 = (0.666666687f * fTemp78);
			dsp->fRec65[0] = (((fTemp79 > 1.0f)?1.0f:((fTemp79 < -1.0f)?-1.0f:(fTemp77 + (0.119999997f - (0.148148149f * mydsp_faustpower3_f(fTemp78)))))) + -0.119999997f);
			dsp->fRec63[0] = ((fSlow40 * dsp->fRec64[0]) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec63[2]) + (dsp->fConst24 * dsp->fRec63[1]))));
			float fTemp80 = (dsp->fConst21 * (dsp->fRec63[2] + (dsp->fRec63[0] + (2.0f * dsp->fRec63[1]))));
			float fTemp81 = (fTemp80 + 0.200000003f);
			float fTemp82 = (0.666666687f * fTemp81);
			float fTemp83 = (((fTemp82 > 1.0f)?1.0f:((fTemp82 < -1.0f)?-1.0f:(fTemp80 + (0.200000003f - (0.148148149f * mydsp_faustpower3_f(fTemp81)))))) + -0.200000003f);
			float fTemp84 = (dsp->fRec73[1] + (fSlow60 * dsp->fRec74[1]));
			float fTemp85 = (1.02040815f * fTemp84);
			float fTemp86 = (min(max(fTemp85, 0.0f), 10.0f) + -0.625f);
			float fTemp87 = (1.77777779f * fTemp86);
			float fTemp88 = (1.33333337f * fabsf(fTemp84));
			float fTemp89 = (min(max(fTemp88, 0.0f), 10.0f) + -0.333333343f);
			float fTemp90 = (1.0f * fTemp89);
			float fTemp91 = ((fTemp84 <= 0.0f)?(0.0f - (0.75f * ((fTemp88 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp90 > 1.0f)?1.0f:((fTemp90 < -1.0f)?-1.0f:(fTemp89 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp89))))))))):fTemp88))):(0.980000019f * ((fTemp85 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp87 > 1.0f)?1.0f:((fTemp87 < -1.0f)?-1.0f:(fTemp86 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp86))))))))):fTemp85)));
			dsp->fRec73[0] = fTemp91;
			dsp->fVec8[0] = fSlow61;
			dsp->fRec76[0] = ((((fSlow61 - dsp->fVec8[1]) > 0.0f) > 0)?dsp->fConst26:max(0.0f, (dsp->fRec76[1] + -1.0f)));
			int iTemp92 = (dsp->fRec76[0] > 0.0f);
			int iTemp93 = (iTemp92 > 0);
			float fTemp94 = expf((0.0f - (dsp->fConst6 / (iTemp93?9.99999975e-05f:fSlow63))));
			dsp->fRec77[0] = ((dsp->fRec77[1] * fTemp94) + ((iTemp93?(float)iTemp92:0.0f) * (1.0f - fTemp94)));
			dsp->fRec75[0] = (((float)iTemp92 + (0.289999992f * dsp->fRec77[0])) - (dsp->fConst3 * ((dsp->fConst9 * dsp->fRec75[2]) + (dsp->fConst10 * dsp->fRec75[1]))));
			float fTemp95 = (dsp->fConst3 * (dsp->fRec75[2] + (dsp->fRec75[0] + (2.0f * dsp->fRec75[1]))));
			float fTemp96 = (fTemp95 - (fTemp91 + (fSlow65 * dsp->fRec74[1])));
			float fTemp97 = (1.02040815f * fTemp96);
			float fTemp98 = (min(max(fTemp97, 0.0f), 10.0f) + -0.625f);
			float fTemp99 = (1.77777779f * fTemp98);
			float fTemp100 = (1.33333337f * fabsf(fTemp96));
			float fTemp101 = (min(max(fTemp100, 0.0f), 10.0f) + -0.333333343f);
			float fTemp102 = (1.0f * fTemp101);
			float fTemp103 = ((fTemp96 <= 0.0f)?(0.0f - (0.75f * ((fTemp100 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp102 > 1.0f)?1.0f:((fTemp102 < -1.0f)?-1.0f:(fTemp101 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp101))))))))):fTemp100))):(0.980000019f * ((fTemp97 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp99 > 1.0f)?1.0f:((fTemp99 < -1.0f)?-1.0f:(fTemp98 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp98))))))))):fTemp97)));
			float fTemp104 = (dsp->fRec74[1] + (fSlow60 * fTemp103));
			float fTemp105 = (1.02040815f * fTemp104);
			float fTemp106 = (min(max(fTemp105, 0.0f), 10.0f) + -0.625f);
			float fTemp107 = (1.77777779f * fTemp106);
			float fTemp108 = (1.33333337f * fabsf(fTemp104));
			float fTemp109 = (min(max(fTemp108, 0.0f), 10.0f) + -0.333333343f);
			float fTemp110 = (1.0f * fTemp109);
			dsp->fRec74[0] = ((fTemp104 <= 0.0f)?(0.0f - (0.75f * ((fTemp108 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp110 > 1.0f)?1.0f:((fTemp110 < -1.0f)?-1.0f:(fTemp109 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp109))))))))):fTemp108))):(0.980000019f * ((fTemp105 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp107 > 1.0f)?1.0f:((fTemp107 < -1.0f)?-1.0f:(fTemp106 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp106))))))))):fTemp105)));
			float fTemp111 = (dsp->fRec78[1] + (fSlow67 * dsp->fRec79[1]));
			float fTemp112 = (1.02040815f * fTemp111);
			float fTemp113 = (min(max(fTemp112, 0.0f), 10.0f) + -0.625f);
			float fTemp114 = (1.77777779f * fTemp113);
			float fTemp115 = (1.33333337f * fabsf(fTemp111));
			float fTemp116 = (min(max(fTemp115, 0.0f), 10.0f) + -0.333333343f);
			float fTemp117 = (1.0f * fTemp116);
			float fTemp118 = ((fTemp111 <= 0.0f)?(0.0f - (0.75f * ((fTemp115 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp117 > 1.0f)?1.0f:((fTemp117 < -1.0f)?-1.0f:(fTemp116 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp116))))))))):fTemp115))):(0.980000019f * ((fTemp112 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp114 > 1.0f)?1.0f:((fTemp114 < -1.0f)?-1.0f:(fTemp113 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp113))))))))):fTemp112)));
			dsp->fRec78[0] = fTemp118;
			float fTemp119 = (fTemp95 - (fTemp118 + (fSlow68 * dsp->fRec79[1])));
			float fTemp120 = (1.02040815f * fTemp119);
			float fTemp121 = (min(max(fTemp120, 0.0f), 10.0f) + -0.625f);
			float fTemp122 = (1.77777779f * fTemp121);
			float fTemp123 = (1.33333337f * fabsf(fTemp119));
			float fTemp124 = (min(max(fTemp123, 0.0f), 10.0f) + -0.333333343f);
			float fTemp125 = (1.0f * fTemp124);
			float fTemp126 = ((fTemp119 <= 0.0f)?(0.0f - (0.75f * ((fTemp123 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp125 > 1.0f)?1.0f:((fTemp125 < -1.0f)?-1.0f:(fTemp124 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp124))))))))):fTemp123))):(0.980000019f * ((fTemp120 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp122 > 1.0f)?1.0f:((fTemp122 < -1.0f)?-1.0f:(fTemp121 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp121))))))))):fTemp120)));
			float fTemp127 = (dsp->fRec79[1] + (fSlow67 * fTemp126));
			float fTemp128 = (1.02040815f * fTemp127);
			float fTemp129 = (min(max(fTemp128, 0.0f), 10.0f) + -0.625f);
			float fTemp130 = (1.77777779f * fTemp129);
			float fTemp131 = (1.33333337f * fabsf(fTemp127));
			float fTemp132 = (min(max(fTemp131, 0.0f), 10.0f) + -0.333333343f);
			float fTemp133 = (1.0f * fTemp132);
			dsp->fRec79[0] = ((fTemp127 <= 0.0f)?(0.0f - (0.75f * ((fTemp131 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp133 > 1.0f)?1.0f:((fTemp133 < -1.0f)?-1.0f:(fTemp132 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp132))))))))):fTemp131))):(0.980000019f * ((fTemp128 > 0.625f)?(1.0f - (0.375f * (1.0f - ((fTemp130 > 1.0f)?1.0f:((fTemp130 < -1.0f)?-1.0f:(fTemp129 * (2.66666675f - (2.80932784f * mydsp_faustpower2_f(fTemp129))))))))):fTemp128)));
			...
			float fTemp134 = (fSlow57 * ((dsp->fRec74[0] + dsp->fRec79[0]) + (fSlow69 * (dsp->fRec80[2] + (dsp->fRec80[0] + (2.0f * dsp->fRec80[1]))))));
			float fTemp135 = (fTemp134 + -0.100000001f);
			float fTemp136 = (0.666666687f * fTemp135);
			float fTemp137 = (((fTemp136 > 1.0f)?1.0f:((fTemp136 < -1.0f)?-1.0f:(fTemp134 + (-0.100000001f - (0.148148149f * mydsp_faustpower3_f(fTemp135)))))) + 0.100000001f);
			float fTemp138 = (fSlow83 * dsp->fRec81[1]);
			float fTemp139 = (fSlow88 * fabsf(dsp->fRec81[1]));
			float fTemp140 = ((dsp->fRec81[1] <= 0.0f)?(0.0f - (fSlow87 * ((fTemp139 > fSlow89)?(1.0f - (fSlow90 * (1.0f - (float)tanhf((float)(fSlow91 * (min(max(fTemp139, 0.0f), 10.0f) - fSlow89)))))):fTemp139))):(fSlow82 * ((fTemp138 > fSlow84)?(1.0f - (fSlow85 * (1.0f - (float)tanhf((float)(fSlow86 * (min(max(fTemp138, 0.0f), 10.0f) - fSlow84)))))):fTemp138)));
			dsp->fVec9[0] = (fSlow92 * fTemp140);
			dsp->fRec82[0] = ((dsp->fConst5 * ((fSlow81 * fTemp140) + (dsp->fConst11 * dsp->fRec82[1]))) - dsp->fVec9[1]);
			float fTemp141 = ((fSlow93 * (fTemp51 + -1.0f)) + 1.0f);
			dsp->fVec10[0] = fSlow94;
			dsp->fVec11[0] = fSlow96;
			float fTemp142 = (dsp->fConst13 * (fSlow96 - dsp->fVec11[1]));
			dsp->fRec84[0] = ((((fSlow94 - dsp->fVec10[1]) > 0.0f) > 0)?0.0f:min(fSlow97, ((dsp->fRec84[1] + fTemp142) + 1.0f)));
			int iTemp143 = (dsp->fRec84[0] < fSlow98);
			dsp->fRec83[0] = ((fTemp141 * (iTemp143?((dsp->fRec84[0] < 0.0f)?0.0f:(iTemp143?(fSlow100 * dsp->fRec84[0]):1.0f)):((dsp->fRec84[0] < fSlow97)?((fSlow99 * (0.0f - (dsp->fRec84[0] - fSlow98))) + 1.0f):0.0f))) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec83[2]) + (dsp->fConst24 * dsp->fRec83[1]))));
			float fTemp144 = ((fSlow80 * dsp->fRec82[0]) + (dsp->fConst21 * (dsp->fRec83[2] + (dsp->fRec83[0] + (2.0f * dsp->fRec83[1])))));
			dsp->fVec12[(dsp->IOTA & 4095)] = fTemp144;
			...
			float fTemp145 = (fSlow83 * dsp->fRec85[1]);
			float fTemp146 = (fSlow88 * fabsf(dsp->fRec85[1]));
			float fTemp147 = ((dsp->fRec85[1] <= 0.0f)?(0.0f - (fSlow87 * ((fTemp146 > fSlow89)?(1.0f - (fSlow90 * (1.0f - (float)tanhf((float)(fSlow91 * (min(max(fTemp146, 0.0f), 10.0f) - fSlow89)))))):fTemp146))):(fSlow82 * ((fTemp145 > fSlow84)?(1.0f - (fSlow85 * (1.0f - (float)tanhf((float)(fSlow86 * (min(max(fTemp145, 0.0f), 10.0f) - fSlow84)))))):fTemp145)));
			dsp->fVec13[0] = (fSlow92 * fTemp147);
			dsp->fRec86[0] = ((dsp->fConst5 * ((fSlow81 * fTemp147) + (dsp->fConst11 * dsp->fRec86[1]))) - dsp->fVec13[1]);
			dsp->fVec14[0] = fSlow119;
			dsp->fRec88[0] = ((((fSlow119 - dsp->fVec14[1]) > 0.0f) > 0)?0.0f:min(fSlow97, ((fTemp142 + dsp->fRec88[1]) + 1.0f)));
			int iTemp148 = (dsp->fRec88[0] < fSlow98);
			dsp->fRec87[0] = ((fTemp141 * (iTemp148?((dsp->fRec88[0] < 0.0f)?0.0f:(iTemp148?(fSlow100 * dsp->fRec88[0]):1.0f)):((dsp->fRec88[0] < fSlow97)?((fSlow99 * (0.0f - (dsp->fRec88[0] - fSlow98))) + 1.0f):0.0f))) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec87[2]) + (dsp->fConst24 * dsp->fRec87[1]))));
			float fTemp149 = ((fSlow118 * dsp->fRec86[0]) + (dsp->fConst21 * (dsp->fRec87[2] + (dsp->fRec87[0] + (2.0f * dsp->fRec87[1])))));
			dsp->fVec15[(dsp->IOTA & 4095)] = fTemp149;
			...
			float fTemp150 = (fSlow83 * dsp->fRec89[1]);
			float fTemp151 = (fSlow88 * fabsf(dsp->fRec89[1]));
			float fTemp152 = ((dsp->fRec89[1] <= 0.0f)?(0.0f - (fSlow87 * ((fTemp151 > fSlow89)?(1.0f - (fSlow90 * (1.0f - (float)tanhf((float)(fSlow91 * (min(max(fTemp151, 0.0f), 10.0f) - fSlow89)))))):fTemp151))):(fSlow82 * ((fTemp150 > fSlow84)?(1.0f - (fSlow85 * (1.0f - (float)tanhf((float)(fSlow86 * (min(max(fTemp150, 0.0f), 10.0f) - fSlow84)))))):fTemp150)));
			dsp->fVec16[0] = (fSlow92 * fTemp152);
			dsp->fRec90[0] = ((dsp->fConst5 * ((fSlow81 * fTemp152) + (dsp->fConst11 * dsp->fRec90[1]))) - dsp->fVec16[1]);
			dsp->fVec17[0] = fSlow138;
			dsp->fRec92[0] = ((((fSlow138 - dsp->fVec17[1]) > 0.0f) > 0)?0.0f:min(fSlow97, ((fTemp142 + dsp->fRec92[1]) + 1.0f)));
			int iTemp153 = (dsp->fRec92[0] < fSlow98);
			dsp->fRec91[0] = ((fTemp141 * (iTemp153?((dsp->fRec92[0] < 0.0f)?0.0f:(iTemp153?(fSlow100 * dsp->fRec92[0]):1.0f)):((dsp->fRec92[0] < fSlow97)?((fSlow99 * (0.0f - (dsp->fRec92[0] - fSlow98))) + 1.0f):0.0f))) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec91[2]) + (dsp->fConst24 * dsp->fRec91[1]))));
			float fTemp154 = ((fSlow137 * dsp->fRec90[0]) + (dsp->fConst21 * (dsp->fRec91[2] + (dsp->fRec91[0] + (2.0f * dsp->fRec91[1])))));
			dsp->fVec18[(dsp->IOTA & 4095)] = fTemp154;
			...
			float fTemp155 = (fSlow83 * dsp->fRec93[1]);
			float fTemp156 = (fSlow88 * fabsf(dsp->fRec93[1]));
			float fTemp157 = ((dsp->fRec93[1] <= 0.0f)?(0.0f - (fSlow87 * ((fTemp156 > fSlow89)?(1.0f - (fSlow90 * (1.0f - (float)tanhf((float)(fSlow91 * (min(max(fTemp156, 0.0f), 10.0f) - fSlow89)))))):fTemp156))):(fSlow82 * ((fTemp155 > fSlow84)?(1.0f - (fSlow85 * (1.0f - (float)tanhf((float)(fSlow86 * (min(max(fTemp155, 0.0f), 10.0f) - fSlow84)))))):fTemp155)));
			dsp->fVec19[0] = (fSlow92 * fTemp157);
			dsp->fRec94[0] = ((dsp->fConst5 * ((fSlow81 * fTemp157) + (dsp->fConst11 * dsp->fRec94[1]))) - dsp->fVec19[1]);
			dsp->fVec20[0] = fSlow157;
			dsp->fRec96[0] = ((((fSlow157 - dsp->fVec20[1]) > 0.0f) > 0)?0.0f:min(fSlow97, ((fTemp142 + dsp->fRec96[1]) + 1.0f)));
			int iTemp158 = (dsp->fRec96[0] < fSlow98);
			dsp->fRec95[0] = ((fTemp141 * (iTemp158?((dsp->fRec96[0] < 0.0f)?0.0f:(iTemp158?(fSlow100 * dsp->fRec96[0]):1.0f)):((dsp->fRec96[0] < fSlow97)?((fSlow99 * (0.0f - (dsp->fRec96[0] - fSlow98))) + 1.0f):0.0f))) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec95[2]) + (dsp->fConst24 * dsp->fRec95[1]))));
			float fTemp159 = ((fSlow156 * dsp->fRec94[0]) + (dsp->fConst21 * (dsp->fRec95[2] + (dsp->fRec95[0] + (2.0f * dsp->fRec95[1])))));
			dsp->fVec21[(dsp->IOTA & 4095)] = fTemp159;
			...
			float fTemp160 = (fSlow70 * ((((0.800000012f * dsp->fRec81[0]) + (0.600000024f * dsp->fRec85[0])) + (0.400000006f * dsp->fRec89[0])) + (0.200000003f * dsp->fRec93[0])));
			float fTemp161 = (fTemp160 + 0.100000001f);
			float fTemp162 = (0.666666687f * fTemp161);
			float fTemp163 = ((fTemp162 > 1.0f)?1.0f:((fTemp162 < -1.0f)?-1.0f:(fTemp160 + (0.100000001f - (0.148148149f * mydsp_faustpower3_f(fTemp161))))));
			dsp->fVec22[0] = fSlow167;
			dsp->fRec98[0] = ((((fSlow167 - dsp->fVec22[1]) > 0.0f) > 0)?dsp->fConst35:max(0.0f, (dsp->fRec98[1] + -1.0f)));
			int iTemp164 = (dsp->fRec98[0] > 0.0f);
			dsp->fVec23[0] = fSlow168;
			dsp->fRec99[0] = ((((fSlow168 - dsp->fVec23[1]) > 0.0f) > 0)?dsp->fConst35:max(0.0f, (dsp->fRec99[1] + -1.0f)));
			int iTemp165 = (dsp->fRec99[0] > 0.0f);
			int iTemp166 = ((iTemp164 + iTemp165) > 0);
			dsp->iVec24[0] = iTemp166;
			int iTemp167 = (iTemp166 > 0);
			int iTemp168 = ((dsp->iVec24[1] <= 0) & iTemp167);
			dsp->fRec100[0] = ((dsp->fRec100[1] * (float)(1 - iTemp168)) + ((float)iTemp168 * ((0.0839999989f * (float)iTemp164) + (fSlow169 * (float)iTemp165))));
			float fTemp169 = expf((0.0f - (dsp->fConst6 / (iTemp167?9.99999975e-05f:dsp->fRec100[0]))));
			dsp->fRec97[0] = ((dsp->fRec97[1] * fTemp169) + ((iTemp167?(float)iTemp166:0.0f) * (1.0f - fTemp169)));
			float fTemp170 = (dsp->fRec102[1] + (fSlow171 * dsp->fRec103[1]));
			...
			dsp->fRec102[0] = fTemp172;
			float fTemp173 = (dsp->fRec105[1] + (fSlow171 * dsp->fRec106[1]));
			float fTemp174 = (0.666666687f * fTemp173);
			float fTemp175 = ((fTemp174 > 1.0f)?1.0f:((fTemp174 < -1.0f)?-1.0f:(fTemp173 - (0.148148149f * mydsp_faustpower3_f(fTemp173)))));
			dsp->fRec105[0] = fTemp175;
			dsp->fVec25[0] = 394.0f;
			float fTemp176 = (dsp->fRec109[1] + (dsp->fConst12 * dsp->fVec25[1]));
			dsp->fRec109[0] = (fTemp176 - floorf(fTemp176));
			float fTemp177 = mydsp_faustpower2_f(((2.0f * dsp->fRec109[0]) + -1.0f));
			dsp->fVec26[0] = fTemp177;
			float fTemp178 = ((fTemp177 - dsp->fVec26[1]) * (float)dsp->iVec1[1]);
			dsp->fVec27[(dsp->IOTA & 255)] = fTemp178;
			dsp->fVec28[0] = 309.0f;
			float fTemp179 = (dsp->fRec110[1] + (dsp->fConst12 * dsp->fVec28[1]));
			dsp->fRec110[0] = (fTemp179 - floorf(fTemp179));
			float fTemp180 = mydsp_faustpower2_f(((2.0f * dsp->fRec110[0]) + -1.0f));
			dsp->fVec29[0] = fTemp180;
			float fTemp181 = ((fTemp180 - dsp->fVec29[1]) * (float)dsp->iVec1[1]);
			dsp->fVec30[(dsp->IOTA & 511)] = fTemp181;
			dsp->fVec31[0] = 493.0f;
			float fTemp182 = (dsp->fRec111[1] + (dsp->fConst12 * dsp->fVec31[1]));
			dsp->fRec111[0] = (fTemp182 - floorf(fTemp182));
			float fTemp183 = mydsp_faustpower2_f(((2.0f * dsp->fRec111[0]) + -1.0f));
			dsp->fVec32[0] = fTemp183;
			float fTemp184 = ((fTemp183 - dsp->fVec32[1]) * (float)dsp->iVec1[1]);
			dsp->fVec33[(dsp->IOTA & 255)] = fTemp184;
			dsp->fVec34[0] = 361.0f;
			float fTemp185 = (dsp->fRec112[1] + (dsp->fConst12 * dsp->fVec34[1]));
			dsp->fRec112[0] = (fTemp185 - floorf(fTemp185));
			float fTemp186 = mydsp_faustpower2_f(((2.0f * dsp->fRec112[0]) + -1.0f));
			dsp->fVec35[0] = fTemp186;
			float fTemp187 = ((fTemp186 - dsp->fVec35[1]) * (float)dsp->iVec1[1]);
			dsp->fVec36[(dsp->IOTA & 511)] = fTemp187;
			dsp->fVec37[0] = 422.0f;
			float fTemp188 = (dsp->fRec113[1] + (dsp->fConst12 * dsp->fVec37[1]));
			dsp->fRec113[0] = (fTemp188 - floorf(fTemp188));
			float fTemp189 = mydsp_faustpower2_f(((2.0f * dsp->fRec113[0]) + -1.0f));
			dsp->fVec38[0] = fTemp189;
			float fTemp190 = ((fTemp189 - dsp->fVec38[1]) * (float)dsp->iVec1[1]);
			dsp->fVec39[(dsp->IOTA & 255)] = fTemp190;
			dsp->fVec40[0] = 203.0f;
			float fTemp191 = (dsp->fRec114[1] + (dsp->fConst12 * dsp->fVec40[1]));
			dsp->fRec114[0] = (fTemp191 - floorf(fTemp191));
			float fTemp192 = mydsp_faustpower2_f(((2.0f * dsp->fRec114[0]) + -1.0f));
			dsp->fVec41[0] = fTemp192;
			float fTemp193 = ((fTemp192 - dsp->fVec41[1]) * (float)dsp->iVec1[1]);
			dsp->fVec42[(dsp->IOTA & 511)] = fTemp193;
			dsp->fRec108[0] = ((dsp->fConst0 * ((((((0.000634517753f * ((fTemp178 - (dsp->fConst46 * dsp->fVec27[((dsp->IOTA - dsp->iConst47) & 255)])) - (dsp->fConst48 * dsp->fVec27[((dsp->IOTA - dsp->iConst49) & 255)]))) + (0.000809061516f * ((fTemp181 - (dsp->fConst52 * dsp->fVec30[((dsp->IOTA - dsp->iConst53) & 511)])) - (dsp->fConst54 * dsp->fVec30[((dsp->IOTA - dsp->iConst55) & 511)])))) + (0.000507099379f * ((fTemp184 - (dsp->fConst58 * dsp->fVec33[((dsp->IOTA - dsp->iConst59) & 255)])) - (dsp->fConst60 * dsp->fVec33[((dsp->IOTA - dsp->iConst61) & 255)])))) + (0.000692520756f * ((fTemp187 - (dsp->fConst64 * dsp->fVec36[((dsp->IOTA - dsp->iConst65) & 511)])) - (dsp->fConst66 * dsp->fVec36[((dsp->IOTA - dsp->iConst67) & 511)])))) + (0.000592417084f * ((fTemp190 - (dsp->fConst70 * dsp->fVec39[((dsp->IOTA - dsp->iConst71) & 255)])) - (dsp->fConst72 * dsp->fVec39[((dsp->IOTA - dsp->iConst73) & 255)])))) + (0.00123152707f * ((fTemp193 - (dsp->fConst76 * dsp->fVec42[((dsp->IOTA - dsp->iConst77) & 511)])) - (dsp->fConst78 * dsp->fVec42[((dsp->IOTA - dsp->iConst79) & 511)]))))) - (dsp->fConst42 * ((dsp->fConst80 * dsp->fRec108[2]) + (dsp->fConst81 * dsp->fRec108[1]))));
			float fTemp194 = (dsp->fConst42 * (((dsp->fConst43 * dsp->fRec108[0]) + (dsp->fConst82 * dsp->fRec108[1])) + (dsp->fConst43 * dsp->fRec108[2])));
			float fTemp195 = (fTemp175 + (fSlow172 * dsp->fRec106[1]));
			float fTemp196 = (fTemp194 - fTemp195);
			float fTemp197 = (0.666666687f * fTemp196);
			float fTemp198 = ((fTemp197 > 1.0f)?1.0f:((fTemp197 < -1.0f)?-1.0f:(fTemp194 - (fTemp195 + (0.148148149f * mydsp_faustpower3_f(fTemp196))))));
			float fTemp199 = (dsp->fRec106[1] + (fSlow171 * fTemp198));
			float fTemp200 = (0.666666687f * fTemp199);
			dsp->fRec106[0] = ((fTemp200 > 1.0f)?1.0f:((fTemp200 < -1.0f)?-1.0f:(fTemp199 - (0.148148149f * mydsp_faustpower3_f(fTemp199)))));
			float fRec107 = fTemp198;
			float fTemp201 = (fTemp172 + (fSlow172 * dsp->fRec103[1]));
			float fTemp202 = (fRec107 - fTemp201);
			float fTemp203 = (0.666666687f * fTemp202);
			float fTemp204 = ((fTemp203 > 1.0f)?1.0f:((fTemp203 < -1.0f)?-1.0f:(fRec107 - (fTemp201 + (0.148148149f * mydsp_faustpower3_f(fTemp202))))));
			float fTemp205 = (dsp->fRec103[1] + (fSlow171 * fTemp204));
			float fTemp206 = (0.666666687f * fTemp205);
			dsp->fRec103[0] = ((fTemp206 > 1.0f)?1.0f:((fTemp206 < -1.0f)?-1.0f:(fTemp205 - (0.148148149f * mydsp_faustpower3_f(fTemp205)))));
			float fRec104 = fTemp204;
			dsp->fRec101[0] = (fRec104 - (dsp->fConst83 * ((dsp->fConst84 * dsp->fRec101[2]) + (dsp->fConst85 * dsp->fRec101[1]))));
			float fTemp207 = ((dsp->fRec97[0] * ((dsp->fConst39 * (dsp->fRec101[2] + (dsp->fRec101[0] + (2.0f * dsp->fRec101[1])))) + (9.31322554e-12f * (float)dsp->iRec60[0]))) * fSlow174);
			dsp->fVec43[0] = fSlow178;
			dsp->fRec118[0] = ((((fSlow178 - dsp->fVec43[1]) > 0.0f) > 0)?dsp->fConst86:max(0.0f, (dsp->fRec118[1] + -1.0f)));
			int iTemp208 = (dsp->fRec118[0] > 0.0f);
			dsp->fVec44[0] = fSlow179;
			dsp->fRec119[0] = ((((fSlow179 - dsp->fVec44[1]) > 0.0f) > 0)?dsp->fConst86:max(0.0f, (dsp->fRec119[1] + -1.0f)));
			int iTemp209 = (dsp->fRec119[0] > 0.0f);
			int iTemp210 = ((iTemp208 + iTemp209) > 0);
			dsp->iVec45[0] = iTemp210;
			int iTemp211 = (((iTemp210 - dsp->iVec45[1]) > 0) > 0);
			dsp->fVec46[0] = fSlow180;
			dsp->fRec117[0] = (iTemp211?0.0f:min(fSlow181, ((dsp->fRec117[1] + (dsp->fConst0 * (fSlow180 - dsp->fVec46[1]))) + 1.0f)));
			int iTemp212 = (dsp->fRec117[0] < dsp->fConst87);
			float fTemp213 = sinf((3.14159274f * min(0.25f, (fSlow176 * ((fSlow177 * (iTemp212?((dsp->fRec117[0] < 0.0f)?0.0f:(iTemp212?(dsp->fConst88 * dsp->fRec117[0]):1.0f)):((dsp->fRec117[0] < fSlow181)?((fSlow182 * (0.0f - (dsp->fRec117[0] - dsp->fConst87))) + 1.0f):0.0f))) + 1.0f)))));
			float fTemp214 = (dsp->fRec115[1] + (2.0f * (fTemp213 * dsp->fRec116[1])));
			float fTemp215 = (min(max(fTemp214, 0.0f), 10.0f) + -0.714285731f);
			float fTemp216 = (2.33333325f * fTemp215);
			float fTemp217 = (1.14942527f * fabsf(fTemp214));
			float fTemp218 = (min(max(fTemp217, 0.0f), 10.0f) + -0.333333343f);
			float fTemp219 = (1.0f * fTemp218);
			float fTemp220 = ((fTemp214 <= 0.0f)?(0.0f - (0.870000005f * ((fTemp217 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp219 > 1.0f)?1.0f:((fTemp219 < -1.0f)?-1.0f:(fTemp218 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp218))))))))):fTemp217))):((fTemp214 > 0.714285731f)?(1.0f - (0.285714298f * (1.0f - ((fTemp216 > 1.0f)?1.0f:((fTemp216 < -1.0f)?-1.0f:(fTemp215 * (3.5f - (6.35185194f * mydsp_faustpower2_f(fTemp215))))))))):fTemp214));
			dsp->fRec115[0] = fTemp220;
			dsp->fRec120[0] = (iTemp211?0.0f:min(dsp->fConst89, (dsp->fRec120[1] + (1.0f - (0.00609999988f * (dsp->fVec0[1] - dsp->fConst0))))));
			int iTemp221 = (dsp->fRec120[0] < dsp->fConst90);
			int iTemp222 = ((dsp->iVec45[1] <= 0) & (iTemp210 > 0));
			dsp->fRec121[0] = ((dsp->fRec121[1] * (float)(1 - iTemp222)) + ((float)iTemp222 * ((0.850000024f * (float)iTemp208) + (fSlow183 * (float)iTemp209))));
			float fTemp223 = (((iTemp221?((dsp->fRec120[0] < 0.0f)?0.0f:(iTemp221?(dsp->fConst91 * dsp->fRec120[0]):1.0f)):((dsp->fRec120[0] < dsp->fConst89)?((dsp->fConst88 * (0.0f - (dsp->fRec120[0] - dsp->fConst90))) + 1.0f):0.0f)) * ((3.25962901e-09f * (float)dsp->iRec60[0]) + 3.0f)) - (fTemp220 + (dsp->fRec116[1] * min((2.0f * (1.0f - powf(dsp->fRec121[0], 0.25f))), min(2.0f, ((1.0f / fTemp213) - fTemp213))))));
			float fTemp224 = (min(max(fTemp223, 0.0f), 10.0f) + -0.714285731f);
			float fTemp225 = (2.33333325f * fTemp224);
			float fTemp226 = (1.14942527f * fabsf(fTemp223));
			float fTemp227 = (min(max(fTemp226, 0.0f), 10.0f) + -0.333333343f);
			float fTemp228 = (1.0f * fTemp227);
			float fTemp229 = ((fTemp223 <= 0.0f)?(0.0f - (0.870000005f * ((fTemp226 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp228 > 1.0f)?1.0f:((fTemp228 < -1.0f)?-1.0f:(fTemp227 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp227))))))))):fTemp226))):((fTemp223 > 0.714285731f)?(1.0f - (0.285714298f * (1.0f - ((fTemp225 > 1.0f)?1.0f:((fTemp225 < -1.0f)?-1.0f:(fTemp224 * (3.5f - (6.35185194f * mydsp_faustpower2_f(fTemp224))))))))):fTemp223));
			float fTemp230 = (dsp->fRec116[1] + (2.0f * (fTemp213 * fTemp229)));
			float fTemp231 = (min(max(fTemp230, 0.0f), 10.0f) + -0.714285731f);
			float fTemp232 = (2.33333325f * fTemp231);
			float fTemp233 = (1.14942527f * fabsf(fTemp230));
			float fTemp234 = (min(max(fTemp233, 0.0f), 10.0f) + -0.333333343f);
			float fTemp235 = (1.0f * fTemp234);
			dsp->fRec116[0] = ((fTemp230 <= 0.0f)?(0.0f - (0.870000005f * ((fTemp233 > 0.333333343f)?(1.0f - (0.666666687f * (1.0f - ((fTemp235 > 1.0f)?1.0f:((fTemp235 < -1.0f)?-1.0f:(fTemp234 * (1.5f - (0.5f * mydsp_faustpower2_f(fTemp234))))))))):fTemp233))):((fTemp230 > 0.714285731f)?(1.0f - (0.285714298f * (1.0f - ((fTemp232 > 1.0f)?1.0f:((fTemp232 < -1.0f)?-1.0f:(fTemp231 * (3.5f - (6.35185194f * mydsp_faustpower2_f(fTemp231))))))))):fTemp230));
			float fTemp236 = ((float)tanhf((float)((fSlow175 * dsp->fRec115[0]) + -0.100000001f)) + 0.100000001f);
			float fTemp237 = (0.5f * fTemp236);
			...
			float fTemp238 = (fSlow70 * ((((0.200000003f * dsp->fRec81[0]) + (0.400000006f * dsp->fRec85[0])) + (0.600000024f * dsp->fRec89[0])) + (0.800000012f * dsp->fRec93[0])));
			float fTemp239 = (fTemp238 + 0.100000001f);
			float fTemp240 = (0.666666687f * fTemp239);
			float fTemp241 = ((fTemp240 > 1.0f)?1.0f:((fTemp240 < -1.0f)?-1.0f:(fTemp238 + (0.100000001f - (0.148148149f * mydsp_faustpower3_f(fTemp239))))));
			dsp->fRec134[0] = ((0.5f * (fTemp241 + -0.100000001f)) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec134[2]) + (dsp->fConst24 * dsp->fRec134[1]))));
			float fTemp242 = (0.0500000007f * fTemp236);
			dsp->fVec48[(dsp->IOTA & 16383)] = (fSlow200 * ((dsp->fConst21 * (dsp->fRec134[2] + (dsp->fRec134[0] + (2.0f * dsp->fRec134[1])))) + (((((fTemp242 + (0.0289999992f * fTemp207)) + (0.294f * fTemp48)) + (0.319999993f * fTemp137)) + (0.600000024f * fTemp59)) + (0.180000007f * fTemp83))));
			float fTemp243 = (0.300000012f * dsp->fVec48[((dsp->IOTA - iSlow201) & 16383)]);
			float fTemp244 = (((0.600000024f * dsp->fRec130[1]) + dsp->fVec47[((dsp->IOTA - dsp->iConst97) & 8191)]) - fTemp243);
			dsp->fVec49[(dsp->IOTA & 1023)] = fTemp244;
			dsp->fRec130[0] = dsp->fVec49[((dsp->IOTA - dsp->iConst98) & 1023)];
			float fRec131 = (0.0f - (0.600000024f * fTemp244));
			...
			float fTemp245 = (((0.600000024f * dsp->fRec135[1]) + dsp->fVec50[((dsp->IOTA - dsp->iConst102) & 16383)]) - fTemp243);
			dsp->fVec51[(dsp->IOTA & 2047)] = fTemp245;
			dsp->fRec135[0] = dsp->fVec51[((dsp->IOTA - dsp->iConst103) & 2047)];
			float fRec136 = (0.0f - (0.600000024f * fTemp245));
			...
			float fTemp246 = (dsp->fVec52[((dsp->IOTA - dsp->iConst107) & 8191)] + (fTemp243 + (0.600000024f * dsp->fRec139[1])));
			dsp->fVec53[(dsp->IOTA & 2047)] = fTemp246;
			dsp->fRec139[0] = dsp->fVec53[((dsp->IOTA - dsp->iConst108) & 2047)];
			float fRec140 = (0.0f - (0.600000024f * fTemp246));
			...
			float fTemp247 = (fTemp243 + ((0.600000024f * dsp->fRec143[1]) + dsp->fVec54[((dsp->IOTA - dsp->iConst112) & 8191)]));
			dsp->fVec55[(dsp->IOTA & 1023)] = fTemp247;
			dsp->fRec143[0] = dsp->fVec55[((dsp->IOTA - dsp->iConst113) & 1023)];
			float fRec144 = (0.0f - (0.600000024f * fTemp247));
			...
			dsp->fRec151[0] = ((0.5f * (fTemp163 + -0.100000001f)) - (dsp->fConst21 * ((dsp->fConst23 * dsp->fRec151[2]) + (dsp->fConst24 * dsp->fRec151[1]))));
			dsp->fVec57[(dsp->IOTA & 16383)] = (fSlow200 * ((((((fTemp242 + (0.261000007f * fTemp207)) + (0.195999995f * fTemp48)) + (dsp->fConst21 * (dsp->fRec151[2] + (dsp->fRec151[0] + (2.0f * dsp->fRec151[1]))))) + (0.479999989f * fTemp137)) + (0.400000006f * fTemp59)) + (0.419999987f * fTemp83)));
			float fTemp248 = (0.300000012f * dsp->fVec57[((dsp->IOTA - iSlow201) & 16383)]);
			float fTemp249 = (dsp->fVec56[((dsp->IOTA - dsp->iConst117) & 8191)] - (fTemp248 + (0.600000024f * dsp->fRec147[1])));
			dsp->fVec58[(dsp->IOTA & 1023)] = fTemp249;
			dsp->fRec147[0] = dsp->fVec58[((dsp->IOTA - dsp->iConst118) & 1023)];
			float fRec148 = (0.600000024f * fTemp249);
			...
			float fTemp250 = (dsp->fVec59[((dsp->IOTA - dsp->iConst122) & 4095)] - (fTemp248 + (0.600000024f * dsp->fRec152[1])));
			dsp->fVec60[(dsp->IOTA & 2047)] = fTemp250;
			dsp->fRec152[0] = dsp->fVec60[((dsp->IOTA - dsp->iConst123) & 2047)];
			float fRec153 = (0.600000024f * fTemp250);
			...
			float fTemp251 = ((fTemp248 + dsp->fVec61[((dsp->IOTA - dsp->iConst127) & 8191)]) - (0.600000024f * dsp->fRec156[1]));
			dsp->fVec62[(dsp->IOTA & 1023)] = fTemp251;
			dsp->fRec156[0] = dsp->fVec62[((dsp->IOTA - dsp->iConst128) & 1023)];
			float fRec157 = (0.600000024f * fTemp251);
			...
			float fTemp252 = ((dsp->fVec63[((dsp->IOTA - dsp->iConst132) & 8191)] + fTemp248) - (0.600000024f * dsp->fRec160[1]));
			dsp->fVec64[(dsp->IOTA & 1023)] = fTemp252;
			dsp->fRec160[0] = dsp->fVec64[((dsp->IOTA - dsp->iConst133) & 1023)];
			float fRec161 = (0.600000024f * fTemp252);
			float fTemp253 = (fRec161 + fRec157);
			float fTemp254 = (fRec148 + (fRec153 + fTemp253));
			dsp->fRec122[0] = (dsp->fRec130[1] + (dsp->fRec135[1] + (dsp->fRec139[1] + (dsp->fRec143[1] + (dsp->fRec147[1] + (dsp->fRec152[1] + (dsp->fRec156[1] + (dsp->fRec160[1] + (fRec131 + (fRec136 + (fRec140 + (fRec144 + fTemp254))))))))))));
			dsp->fRec123[0] = ((dsp->fRec147[1] + (dsp->fRec152[1] + (dsp->fRec156[1] + (dsp->fRec160[1] + fTemp254)))) - (dsp->fRec130[1] + (dsp->fRec135[1] + (dsp->fRec139[1] + (dsp->fRec143[1] + (fRec131 + (fRec136 + (fRec144 + fRec140))))))));
			float fTemp255 = (fRec153 + fRec148);
			dsp->fRec124[0] = ((dsp->fRec139[1] + (dsp->fRec143[1] + (dsp->fRec156[1] + (dsp->fRec160[1] + (fRec140 + (fRec144 + fTemp253)))))) - (dsp->fRec130[1] + (dsp->fRec135[1] + (dsp->fRec147[1] + (dsp->fRec152[1] + (fRec131 + (fRec136 + fTemp255)))))));
			dsp->fRec125[0] = ((dsp->fRec130[1] + (dsp->fRec135[1] + (dsp->fRec156[1] + (dsp->fRec160[1] + (fRec131 + (fRec136 + fTemp253)))))) - (dsp->fRec139[1] + (dsp->fRec143[1] + (dsp->fRec147[1] + (dsp->fRec152[1] + (fRec140 + (fRec144 + fTemp255)))))));
			float fTemp256 = (fRec161 + fRec153);
			float fTemp257 = (fRec157 + fRec148);
			dsp->fRec126[0] = ((dsp->fRec135[1] + (dsp->fRec143[1] + (dsp->fRec152[1] + (dsp->fRec160[1] + (fRec136 + (fRec144 + fTemp256)))))) - (dsp->fRec130[1] + (dsp->fRec139[1] + (dsp->fRec147[1] + (dsp->fRec156[1] + (fRec131 + (fRec140 + fTemp257)))))));
			dsp->fRec127[0] = ((dsp->fRec130[1] + (dsp->fRec139[1] + (dsp->fRec152[1] + (dsp->fRec160[1] + (fRec131 + (fRec140 + fTemp256)))))) - (dsp->fRec135[1] + (dsp->fRec143[1] + (dsp->fRec147[1] + (dsp->fRec156[1] + (fRec136 + (fRec144 + fTemp257)))))));
			float fTemp258 = (fRec161 + fRec148);
			float fTemp259 = (fRec157 + fRec153);
			dsp->fRec128[0] = ((dsp->fRec130[1] + (dsp->fRec143[1] + (dsp->fRec147[1] + (dsp->fRec160[1] + (fRec131 + (fRec144 + fTemp258)))))) - (dsp->fRec135[1] + (dsp->fRec139[1] + (dsp->fRec152[1] + (dsp->fRec156[1] + (fRec136 + (fRec140 + fTemp259)))))));
			dsp->fRec129[0] = ((dsp->fRec135[1] + (dsp->fRec139[1] + (dsp->fRec147[1] + (dsp->fRec160[1] + (fRec136 + (fRec140 + fTemp258)))))) - (dsp->fRec130[1] + (dsp->fRec143[1] + (dsp->fRec152[1] + (dsp->fRec156[1] + (fRec131 + (fRec144 + fTemp259)))))));
			float fTemp260 = (((0.400000006f * fTemp60) + ((0.699999988f * fTemp83) + ((0.600000024f * fTemp137) + (fTemp163 + ((0.899999976f * fTemp207) + (fTemp237 + (0.370000005f * (dsp->fRec123[0] + dsp->fRec124[0])))))))) + -0.100000001f);
			float fTemp261 = (((0.600000024f * fTemp60) + (fTemp241 + ((0.300000012f * fTemp83) + ((0.400000006f * fTemp137) + (fTemp237 + (0.370000005f * (dsp->fRec123[0] - dsp->fRec124[0]))))))) - (0.100000001f * (1.0f - fTemp207)));
			float fTemp262 = fabsf((fabsf(fTemp260) + fabsf(fTemp261)));
			float fTemp263 = ((dsp->fRec165[1] > fTemp262)?fSlow269:fSlow268);
			dsp->fRec166[0] = ((dsp->fRec166[1] * fTemp263) + (fTemp262 * (1.0f - fTemp263)));
			dsp->fRec165[0] = dsp->fRec166[0];
			dsp->fRec164[0] = ((fSlow266 * dsp->fRec164[1]) + (fSlow267 * max(((20.0f * log10f(dsp->fRec165[0])) - fSlow270), 0.0f)));
			float fTemp264 = powf(10.0f, (0.0500000007f * dsp->fRec164[0]));
			output0[i] = (FAUSTFLOAT)(float)tanhf((float)(fTemp260 * fTemp264));
			output1[i] = (FAUSTFLOAT)(float)tanhf((float)(fTemp261 * fTemp264));
